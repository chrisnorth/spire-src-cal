...
try:
    ...
    print '**ERROR** Cannot load RadialCorrBeam %s from %s'%(verBeamProf[0]['name'],verBeamProf[0]['type'])
    beamProfRead=False
try:
    ...
    print '**ERROR** Cannot load RadialCorrBeam %s from %s'%(verBeamProf[1]['name'],verBeamProf[1]['type'])
    beamProfRead=False
...
try:
    ...
    print '**ERROR** Cannot load ColorCorrBeam %s from %s'%(verKBeam[0]['name'],verKBeam[0]['type'])
    kBeamRead=False
try:    
    ...
    print '**ERROR** Cannot load ColorCorrBeam %s from %s'%(verKBeam[1]['name'],verKBeam[1]['type'])
    kBeamRead=False
...
try:
    ...
    print '**ERROR** Cannot load ColorCorrK_point %s from %s'%(verKPsrc[0]['name'],verKPsrc[0]['type'])
    kPsrcRead=False
...
try:
    ...
    print '**ERROR** Cannot load ColorCorrK_point %s from %s'%(verKPsrc[1]['name'],verKPsrc[1]['type'])
    kPsrcRead=False
...
try:
    ...
    print '**ERROR** Cannot load ColorCorrK_extended %s from %s'%(verKExtd[0]['name'],verKExtd[0]['type'])
    kExtdRead=False
...
try:
    ...
    print '**ERROR** Cannot load ColorCorrK_extended %s from %s'%(verKExtd[1]['name'],verKExtd[1]['type'])
    kExtdRead=False
...
try:
    ...
    print '**ERROR** Cannot load ColorCorrAperture_noBG %s from %s'%(verApCorr[0]['name'],verApCorr[0]['type'])
    apCorrNoBGRead=False
...
try:
    ...
    print '**ERROR** Cannot load ColorCorrAperture_noBG %s from %s'%(verApCorr[1]['name'],verApCorr[1]['type'])
    apCorrNoBGRead=False
...
try:
    ...
    print '**ERROR** Cannot load ColorCorrAperture_incBG %s from %s'%(verApCorr[0]['name'],verApCorr[0]['type'])
    apCorrIncBGRead=False
...
try:
    ...
    print '**ERROR** Cannot load ColorCorrAperture_incBG %s from %s'%(verApCorr[1]['name'],verApCorr[1]['type'])
    apCorrIncBGRead=False
...
try:
    ...
    print '**ERROR** Cannot load ColorCorrHfi %s from %s'%(verKHfi[0]['name'],verKHfi[0]['type'])
    kHfiRead=False
...
try:
    ...
    print '**ERROR** Cannot load ColorCorrHfi %s from %s'%(verKHfi[1]['name'],verKHfi[1]['type'])
    kHfiRead=False
